...
| V6 | 电工杨小飞 18 讲 + 张海如 66 讲 | 中文 | ★★★★ | B 站 iframe + 引导卡片 |
| V7 | 亿道/锌锦 · 2025 新功能中文图文 | 中文 | ★★★★ | 引导卡片 |
| V8 | 沐江电气 · 新版 Eplan2025 培训 14 讲 | 中文 | ★★★★ | B 站 iframe（JS 播放列表） |
| V9 | 电气知识共享 · EPLAN 设计制图 24 课 | 中文 | ★★★★ | B 站 iframe（12 讲速切） |
| V10 | 电气设计圈 · 零基础逆袭全流程 19 讲（真实合集19P） | 中文 | ★★★★ | B 站 iframe（12 讲速切） |
| V11 | 工控圈 · 实战应用 142 课（原200讲稿件不可见，已替换为该UP主最大公开合集 142 课+兄弟88集） | 中文 | ★★★★★ | B 站 iframe（12 讲速切） |
...
| V6 | 电工杨小飞 + 张海如 | EPLAN 绘图实战合集 | 中文 | 18+66 讲（杨小飞4讲内嵌，单讲单BV） | ★★★★ 中文实战 | B 站 iframe + 引导 |
| V7 | 亿道数字/山东锌锦 | 2025 新功能中文图文 | 中文 | 图文 | ★★★★ 中文解读 | 引导卡片 |
| V8 | 沐江电气 | 新版 Eplan2025 培训教程 | 中文 | 14 讲（8 讲内嵌 + 合集） | ★★★★ 2025 新版专讲 | B 站 iframe |
| V9 | 电气知识共享 | EPLAN 电气设计制图（玩转项目） | 中文 | 24 讲（12 讲速切） | ★★★★ 工业帮同级系统化 | B 站 iframe |
| V10 | 电气设计圈 | 零基础逆袭全流程 | 中文 | 19 讲（12 讲速切，真实合集19P） | ★★★★ 全流程项目 | B 站 iframe |
| V11 | 工控圈 | 实战应用合集142课+兄弟88集 | 中文 | 230+讲（12讲速切） | ★★★★★ 最大免费公开合集(31.2万播) | B 站 iframe |
